{ $Id: UnitTests.dpr,v 1.3 2006/01/05 12:25:25 koizuka Exp $ }
...
uses
  ...
  GUITestRunner,
  TextTestRunner,
  TestCharSetDetector in 'TestCharSetDetector.pas',
  TestUrlUnit in 'TestUrlUnit.pas',
  TestBase64 in 'TestBase64.pas';
