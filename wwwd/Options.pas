...
const
  ...
  RegValueFireFoxCommandLine = 'FireFoxCommandLine';
  RegValueOpenNewBrowser = 'OpenNewBrowser';
...
begin
  ...
  if Reg.ValueExists(RegValueFireFoxCommandLine) then
    FireFoxCommandLine := Reg.ReadBool(RegValueFireFoxCommandLine);
  ...
  if Reg.ValueExists(RegValueOpenNewBrowser) then
    OpenNewBrowser := Reg.ReadBool(RegValueOpenNewBrowser);
end;
...
begin
  ...
  Reg.WriteBool(RegValueFireFoxCommandLine, FireFoxCommandLine);
  Reg.WriteString(RegValueFindText, FindText );
  Reg.WriteInteger(RegValueMaxConnection, MaxConnection);
  Reg.WriteBool(RegValueOpenNewBrowser, OpenNewBrowser);
end;
